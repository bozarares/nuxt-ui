...
const docsProps = [
	...
	},
	{
		attribute: "error",
		type: "String",
		description: "Defines the error shown below the component.",
	},
	{
		attribute: "disabled",
		type: "Boolean",
	...
	{
		attribute: "validityCheck",
		type: "Boolean",
		description: "Controls whether the search input should match the searched list item.",
	},
	{
		attribute: "onValidityChange",
		type: "Function",
		description: "It will trigger when the validity changes.",
	},
	{
		attribute: "options",
		type: "Object",
		...
		value: [
			...
			},
			{
				...
				type: "Object",
				description:
					"Defines the icon that will be visible when the input option is valid.",
			},
		],
	},
];
